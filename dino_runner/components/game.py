...
from utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, CLOUD, RESET, GAME_OVER, DINO_DEAD
...
class Game:
    ...
    def update(self):
        ...
        self.dinosaur.update(user_input, self.game_over)
    ...
    def draw_menu_reset(self):
            ...
            self.screen.blit(DINO_DEAD, (50, 300) )

    def show_menu_reset(self):
        self.game_running = True 
        if self.index_show_menu > 1:
